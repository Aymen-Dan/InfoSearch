...
public class BSBI {
    ...
    public void write(){
        ...
        try {
            ...
            FileWriter fw = new FileWriter("C:\\Users\\armad\\OneDrive\\Desktop\\infosearch\\InfoS_PR5\\InfoSearch_PR5\\src\\results\\block"+block_count+".txt");
    ...
    public void merge(){
        ...
        FileWriter fw = null;
        try {
            fw = new FileWriter("C:\\Users\\armad\\OneDrive\\Desktop\\infosearch\\InfoS_PR5\\InfoSearch_PR5\\src\\results\\block_final.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }
        bw = new BufferedWriter(fw);
        ...
        try {
            ...
            for(int i=0;i<block_count;i++) {
                File f = new File("C:\\Users\\armad\\OneDrive\\Desktop\\infosearch\\InfoS_PR5\\InfoSearch_PR5\\src\\results\\block" + i + ".txt");
        ...
        end_block_size = (new File("C:\\Users\\armad\\OneDrive\\Desktop\\infosearch\\InfoS_PR5\\InfoSearch_PR5\\src\\results\\block_final.txt").length()/1024.0);
    }
